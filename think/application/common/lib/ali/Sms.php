...
require_once ENV::get('APP_PATH') . '../extend/ali/vendor/autoload.php';
...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = MyConfig::get('myconfig.aliSms.accessKeyId'); // AccessKeyId

        $accessKeySecret = MyConfig::get('myconfig.aliSms.accessKeySecret'); // AccessKeySecret
    ...
    public static function sendSms($phone, $code) {
        ...
        $request->setSignName(MyConfig::get('myconfig.aliSms.signName'));

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode(MyConfig::get('myconfig.aliSms.templateCode'));
